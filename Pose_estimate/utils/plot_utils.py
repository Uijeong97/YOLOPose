...
def draw_strike_zone(img, base_coordinate, zone_height):
    ...
    #outline
    cv2.line(img, (b_x0,b_y1 - h_min),(b_x1, b_y1 - h_min),(255,255,255),2) # bottom
    cv2.line(img, (b_x0,b_y1 - h_min), (b_x0, b_y0 - h_min - h_max), (255,255,255), 2) #left
    cv2.line(img, (b_x0, b_y0 - h_min - h_max), (b_x1, b_y0 - h_min - h_max), (255,255,255), 2) # right
    cv2.line(img, (b_x1, b_y1 - h_min), (b_x1, b_y0 - h_min - h_max), (255,255,255), 2) #top

    #inner line
    cv2.line(img, (b_x0, int(b_y1-h_min-h_max/3)), (b_x1, int(b_y1-h_min-h_max/3)),(255,255,255),2)
    cv2.line(img, (b_x0, int(b_y1 - h_min - h_max*(2 / 3))), (b_x1, int(b_y1 - h_min - h_max*(2 / 3))), (255, 255, 255), 2)
    cv2.line(img, (int(b_x0 + (b_x1 - b_x0)/3),b_y0-h_min-h_max), (int(b_x0 + (b_x1 - b_x0)/3), b_y1-h_min), (255,255,255),2)
